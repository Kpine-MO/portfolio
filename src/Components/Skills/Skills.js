  ...
  return (
    <div className="skillz">
      <div className="skillsLayer1">
        ...
        <h3 className="skillsMain allProjH1 ">Skills</h3>
        <div className="spanStyle spanStyleSkills"></div>
        </div>
      <div className="development">
        <div className="skillsIcon settingsIcon">
      ...
      <div className="skillsLayer1right">
        <div className="projectsDone">
          <div className="skillsIcon projectsIcon">
            <VscProject size={20} />
          </div>
        ...
        <div className="skillsFlex">
          <div className="tools">
            <div className="skillsIcon toolsIcon">
              <BsTools size={20} />
            </div>
          ...
          <div className="knowledge">
            <div className="skillsIcon bulbIcon">
              <TbBulb size={30} />
            </div>
